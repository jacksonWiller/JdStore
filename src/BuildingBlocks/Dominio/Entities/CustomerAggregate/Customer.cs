using System;
using JdMarketplace.Core.Dominio.Entities.CustomerAggregate.Events;
...
public class Customer : BaseEntity, IAggregateRoot
{
    ...
    public Customer(string firstName, string lastName, EGender gender, EmailNew email, DateTime dateOfBirth)
    {
        FirstName = firstName;
        LastName = lastName;
        Gender = gender;
    ...
    /// </summary>
    public EmailNew Email { get; private set; }
    ...
    public void ChangeEmail(EmailNew newEmail)
    {
