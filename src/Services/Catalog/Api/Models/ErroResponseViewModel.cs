...
namespace JdMarketplace.Api.Models
{
    public class ErroResponseViewModel
    {
        public ErroResponseViewModel()
        {
            TraceId = Guid.NewGuid().ToString();
            Errors = new List<ErrorDetailsVm>();
        }

        public ErroResponseViewModel(string logref, string message)
        {
            TraceId = Guid.NewGuid().ToString();
            Errors = new List<ErrorDetailsVm>();
